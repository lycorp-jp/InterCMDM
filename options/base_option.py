...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--cache', type=str2bool, default=True, help='cache the dataset')
        ...
        # Wandb options
        self.parser.add_argument('--project_name', type=str, default='InterCMDM', help='Wandb project name')
        self.parser.add_argument('--entity', type=str, default='user_name', help='Wandb entity/username')
